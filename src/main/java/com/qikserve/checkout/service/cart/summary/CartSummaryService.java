...
public class CartSummaryService implements ICartSummaryService{
    ...
    public CartSummary getCartSummaryById(Long cartSummaryId) {
        return cartSummaryRepository.findById(cartSummaryId).orElseThrow(()-> new CartSummaryNotFoundException(cartSummaryId));
    }

    @Override
    public CartSummary getCartSummaryByCartId(Long cartId) {
        return cartSummaryRepository.findByCartId(cartId).orElseThrow(()-> new CartSummaryNotFoundException(cartId));
    }
